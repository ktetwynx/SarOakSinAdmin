          ...
          <div className="body">
            ...
            <Routes>
              <Route
                ...
                path="/"
                element={
                  token ? <Navigate to="/category" /> : <Navigate to="/login" />
                }
              />
              <Route
                exact
            ...
            <Route exact path="/category" element={<Category />} /> */}
              <Route
                exact
                path="/author"
                element={token ? <Author /> : <Navigate to="/login" />}
              />
              <Route
                exact
                path="/book"
              ...
              <Route
                exact
                path="/singer"
                element={token ? <Singer /> : <Navigate to="/login" />}
              />
              <Route
                exact
                path="/album"
              ...
              <Route
                exact
                path="/lyric"
                element={token ? <Lyric /> : <Navigate to="/login" />}
              />
              <Route
                exact
                path="/lyric/create"
                element={token ? <CreatetLyric /> : <Navigate to="/login" />}
              />
              <Route
                exact
                path="/book/create"
              ...
              <Route
                exact
                path="/author/create"
                element={token ? <CreateAuthor /> : <Navigate to="/login" />}
              />
              <Route
                exact
                path="/author/edit"
              ...
              <Route
                ...
                element={token ? <CreateCategory /> : <Navigate to="/login" />}
              />
              ...
              <Route
                exact
                path="/singer/create"
                element={token ? <CreateSinger /> : <Navigate to="/login" />}
              />
              <Route
                exact
                path="/singer/edit"
              ...
              <Route
                exact
                path="/album/edit"
                element={token ? <CreateAlbum /> : <Navigate to="/login" />}
              />
              <Route
                exact
                path="/album/create"
